var __DEFINE_API__ = (function (l) {
  ...
  function i(t) {
    try {
      const { pathname: e, search: n } = new URL(t);
      return `${e}${n}`;
    } catch (e) {
      return t;
    }
  ...
  function T(t, e) {
    return (
      ...
      t.endsWith("giây trước")
        ...
        ? e - parseInt(t) * 1e3 * 60 * 60
        : t.endsWith("ngày trước")
        ? e - parseInt(t) * 1e3 * 60 * 60 * 24
        : t.endsWith("tháng trước")
        ? e - parseInt(t) * 1e3 * 60 * 60 * 24 * 30
        : t.endsWith("năm trước")
        ? e - parseInt(t) * 1e3 * 60 * 60 * 24 * 365
        : new Date(
            t.replace(
  ...
  const at = [
    ...
    It = [
      ...
      },
      {
        name: "Server 2",
        has: ({ pages: t }) =>
          t[0].original !== null && t[0].original !== t[0].src,
        parse({ pages: t }) {
          return t.map((e) => {
            var n;
